...
export default function GraficoPerformanceSemanal({ data }) {
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.16 }}>
      <Card className="rounded-3xl border-white/10 bg-white/[0.04] p-5 shadow-xl shadow-black/10">
        <div className="mb-4">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-white/35">Performance Semanal</p>
          <h3 className="mt-2 text-xl font-bold text-white">Desempenho por dia da semana</h3>
        </div>
