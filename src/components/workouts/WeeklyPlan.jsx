...
import { getPersistentExerciseImage } from "./resolveExerciseImage";
                    ...
                    <div className="px-6 pb-6 border-t border-white/10 pt-4">
                      <div className="space-y-3">
                        {dayPlan.exercises.map((exercise, i) => {
                          const exerciseImage = getPersistentExerciseImage(savedExercises, exercise.name);
                          ...
                          return (
                            ...
                            >
                              <div className="w-14 h-14 overflow-hidden rounded-lg border border-white/10 bg-white/5 flex-shrink-0">
                                {exerciseImage ? (
                                  <img 
                                    src={exerciseImage} 
                                    alt={exercise.name}
